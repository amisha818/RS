        ...
        return (
            <div className="card animated fadeInLeft">
                <div className="card-body">
                    ...
                    <h3 className="card-title">Projects' Information</h3>
                    <hr />
                </div>
                <form onSubmit={this.continue}>
                    ...
                    <div className="row col-lg-10 mx-auto">
                        <div className="col-lg-12 text-left">
                            <h3><b><i className="fas fa-check-circle mr-1"></i>First Project</b></h3>
                        </div>
                    ...
                    <div className="row col-lg-10 mx-auto">
                        <div className="col-lg-12 text-left">
                            <h3><b><i className="fas fa-check-circle mr-1"></i>Second Project</b></h3>
                            <hr/>
                        </div>
                        <div className="col-lg-6 text-left">
                            <label>Title*</label>
